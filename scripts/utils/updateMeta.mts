...
const latestReleaseInformation = await fetch("https://api.github.com/repos/PaperTobi/Skibiditop/releases/latest", {
    headers: {
...
const metaInfo = await fs.readFile("./meta/io.github.papertobi.skibiditop.metainfo.xml", "utf-8");
...
await fs.writeFile("./meta/io.github.papertobi.skibiditop.metainfo.xml", output, "utf-8");
