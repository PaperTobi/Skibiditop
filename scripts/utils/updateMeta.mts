...
const metaInfo = await fs.readFile("./meta/dev.papertobi.Skibiditop.metainfo.xml", "utf-8");
...
await fs.writeFile("./meta/dev.papertobi.Skibiditop.metainfo.xml", output, "utf-8");
